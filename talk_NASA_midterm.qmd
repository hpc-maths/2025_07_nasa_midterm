...
## A dual ImEx/Splitting strategy for stiff PDEs {.fs-4}
...
## An ImEx strategy for stiff reaction-diffusion {.fs-5}
...
- ImEx strategy implemented in ponio - coupled to samurai 
  - Implicit on source term / explicit for diffusion without von Neumann stability limit (ROCK)
